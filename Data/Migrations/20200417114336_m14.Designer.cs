...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sklad.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("sklad.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("sklad.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("sklad.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("sklad.Models.Order", b =>
                {
                    ...
                    b.HasOne("sklad.Models.ApplicationUser", "Driver")
            ...
            modelBuilder.Entity("sklad.Models.OrderItem", b =>
                {
                    b.HasOne("sklad.Models.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("sklad.Models.Order", "Order")
                        .WithMany("OrderItems")
